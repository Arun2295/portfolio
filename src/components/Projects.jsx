                        ...
                        >
                            <div className="projects__card-image">
                                <div className="projects__card-placeholder">
                                    <span className="projects__card-emoji">
                                ...
                                <div className="projects__card-overlay">
                                    <div className="projects__card-links">
                                        {project.github && (
                                            <a href={project.github} target="_blank" rel="noopener noreferrer" className="projects__card-link" aria-label="View source code">
                                        ...
                                        {project.live && (
                                            <a href={project.live} target="_blank" rel="noopener noreferrer" className="projects__card-link" aria-label="View live demo">
